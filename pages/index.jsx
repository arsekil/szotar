  ...
  return (
    <>
      ...
      <div className={styles.attrib}>
        <div>
          <Link
            href="https://www.freepik.com/free-vector/abstract-low-poly-connection-lines-digital-technology-background_8562956.htm#query=data&position=2&from_view=keyword&track=sph"
            target="_blank"
          >
        ...
        <div>
          <Link
            href="https://www.freepik.com/free-vector/bar-charts_38271363.htm#query=bar%20chart&position=9&from_view=search&track=ais"
            target="_blank"
          >
