  ...
  return (
    <>
      ...
      <div className={styles.entryContainerNevek}>
        ...
        <div className={styles.entryContainerMenuAbout} onClick={handleAbout}>
          Rólunk
        </div>
      </div>
      {!isCollapsed ? (
        <div className={styles.collapsible} style={contentStyle}>
          <ul className={styles.notSelectedName}>
        ...
        <>
          <div className={styles.ULStyle}>
            <div className={styles.selectedName} onClick={handleClick}>
              ...
              <div className={styles.selectedNameChild}>
                Beküldött:
                {szotar.reduce((p, c) => {
                  selectedName === c.bekuldo2 ? p++ : p;
                  return p;
                }, 0)}
              </div>
              <div className={styles.selectedNameChild}>
