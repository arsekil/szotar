  ...
  return (
    <>
      ...
      <div className={styles.entryNavBtn}>
        <div
          className={styles.entryContainerNavBtnLeft}
          onClick={handlePrev}
        ></div>
        <div className={styles.entryMain}>
          <div className={styles.entryContainer}>
            ...
            <div className={styles.entryContainerNevek}>
              ...
              <div
                className={styles.entryContainerMenuAbout}
                onClick={handleAbout}
              >
                Rólunk
              </div>
        ...
        <div
          className={styles.entryContainerNavBtnRight}
          onClick={handleNext}
        ></div>
      </div>
    </>
